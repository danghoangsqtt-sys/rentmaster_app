  ...
  return (
    <div className="min-h-full bg-slate-50 pb-20 animate-in slide-in-from-right-10 duration-500">
      <div className="bg-white px-4 py-4 flex items-center justify-between sticky top-0 z-50 border-b border-slate-100 shadow-sm">
        ...
        <button onClick={handleSave} className="bg-blue-600 text-white px-4 py-2 rounded-xl text-[10px] font-black uppercase flex items-center gap-1.5 shadow-lg shadow-blue-100 active:scale-95 transition-all">
        ...
        <div className="flex flex-col items-center">
          <div className="relative group">
            <div className="w-24 h-24 rounded-[2.5rem] overflow-hidden border-4 border-white shadow-xl bg-slate-100">
              <img src={formData.photo || 'https://i.pravatar.cc/150?u=manager'} alt="Profile" className="w-full h-full object-cover" />
            </div>
            <button 
